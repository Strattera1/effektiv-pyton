...
__countries = [
  ...
  },
  {
    'name': 'Bouvet Island',
    'capital': '',
    'languages': ['Norwegian', 'Norwegian Bokm̴l', 'Norwegian Nynorsk'],
    'population': 0,
...
countries = [ Country(x["name"],x["capital"], x["currency"], x["population"], x["languages"]) for x in __countries ]
